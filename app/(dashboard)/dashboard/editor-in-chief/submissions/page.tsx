import { EditorInChiefManuscriptsPageTab } from "@/app/components/@dashboard/components/@dashboard/common/config/tabs";
...
export default function SubmissionsPage() {
  return (
    <PageLayout>
      ...
      <PageTabs pageName="Submissions" tabs={EditorInChiefManuscriptsPageTab} />
    </PageLayout>
  );
}
